function [timestamp,filename] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIMESTAMP,FILENAME] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [TIMESTAMP,FILENAME] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [timestamp,filename] = importfile('rgb.txt',4, 801);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/02/06 17:33:53
