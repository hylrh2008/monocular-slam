...
%   [TIMESTAMP,TX,TY,TZ,QX,QY,QZ,QW] = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   [TIMESTAMP,TX,TY,TZ,QX,QY,QZ,QW] = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [timestamp,tx,ty,tz,qx,qy,qz,qw] = importfile('groundtruth.txt',3, 3003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/02/06 16:04:57
...
formatSpec = '%15s%7s%7s%7s%7s%7s%8s%s%[^\n\r]';
