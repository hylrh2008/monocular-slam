...
%
%   [TIMESTAMP,TX,TY,TZ,QX,QY,QZ,QW] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [timestamp,tx,ty,tz,qx,qy,qz,qw] = importfile('pose.txt',1, 182);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/02/06 18:41:06
