...
struct depth_hypothesis{
  ...
  cv::Mat1f d;
  cv::Mat1f variance; // of INVERSE depth!
...
private:
  ...
  void warp_maps_forward(const Eigen::Affine3d &transformationx);
  void warp_depth_forward(const Eigen::Affine3d &transformationx, const cv::Mat1f &old_intensity, const cv::Mat1f &new_intensity);
